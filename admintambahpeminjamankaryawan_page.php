<?php
    ...
    $_SESSION['idkry'] = $_GET['id'];
    $idkary = $_SESSION['idkry'];
    // echo $idkary;
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Peminjaman Karyawan</title>
...
<body>
    ...
    <div class="col-md-8 col-md-offset-2 main">
        ...
        <form class="input-group" action="admintambahpeminjamankaryawan_page.php?id=<?php echo $idkary?>" method="POST">
            <input type="text" class="form-control" placeholder="Pencarian" name="cari" <?php echo $checkdata['aaa'] == 0 ? 'disabled' : '' ?>>
            <span class="input-group-btn">
                <input class="btn btn-primary" type="submit" value="Cari" <?php echo $checkdata['aaa'] == 0 ? 'disabled' : '' ?>>
            </span>
        </form>
        <?php 
            if(isset($_POST['cari'])){
        ...
        <br>
        <div class="row">
            <form role="form" onsubmit="return foo();" enctype="multipart/form-data" action="proses/admintambahpeminjamankaryawan_proses.php" method="post">
                <?php
                    if (isset($_POST['cari'])) {
                        $cari = $_POST['cari'];
