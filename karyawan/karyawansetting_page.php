        ...
        <div class="modal-dialog" style="margin-bottom:0;">
            <div class="modal-content" style="background-color: rgba(255, 255, 255, .85);">
                ...
                <div class="panel-body">
                    <form action="proses/karyawanchangepassword_proses.php" method="post">
                        <fieldset>
                            <div class="form-group">
                                <input class="form-control" name="username" type="text" value="<?php echo $idkaryawan?>" style="text-align:center;" disabled>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="buttonControl">
                                ...
                                <input type="button" class="btn btn-md btn-danger" onclick="location.href='karyawandashboard_page.php'" value="Kembali">
                            </div>
                        </fieldset>
                    </form>
                </div>
