                ...
                <table class="table table-bordered table-striped table-hover table-resonsive">
                    ...
                    <?php                        
                        ...
                        <tr>
                            ...
                            ?>
                            <td class="text-center"><a class="btn btn-<?php echo $xxx['aaa'] == $yyy['aaa'] ? 'success' : 'danger' ?> fa fa-border fa-<?php echo $xxx['aaa'] == $yyy['aaa'] ? 'check' : 'remove' ?>" data-toggler="tootltip" title="<?php echo $xxx['aaa'] == $yyy['aaa'] ? 'Sudah Mengembalikan Semua Barang' : 'Masih Dalam Peminjaman' ?>"></a></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                </table>                
